      ...
      <div className={`nav-wrap ${scrolled ? 'is-scrolled' : ''}`} ref={navRef}>
        <nav className="nav-bar">
          ...
          <a
            ...
            className="hidden xl:inline-flex items-center gap-2 px-3.5 py-1.5 bg-white text-slate-800 border border-slate-200 rounded-full text-xs font-bold shadow-sm hover:shadow-md hover:scale-105 transition text-decoration-none"
            title="Verified 4.8 Star Rating on Google Reviews"
          >
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-slate-500 font-medium text-[11px]">(Google)</span>
            </div>
          </a>
